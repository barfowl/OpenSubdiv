...
//  subsets of subsets, we avoid intentionally avoid having to re-compute
...
public:
    ...
    bool HasSharpEdges()         const { return  _anySharpEdges; }
    ...
    bool IsInteriorVal2()        const { return  _interiorVal2Verts; }
...
//  the bitwise-OR with a given CornerTag.
//
...
public:
    ...
    bool HasInteriorVal2Vertices() const { return _interiorVal2Verts; }
    bool HasNonSharpBoundary()     const { return _boundaryNonSharp; }
